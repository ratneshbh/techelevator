...
-- The name, population, and GNP of all countries with a 
--GNP greater than $1 trillion dollars and a population of less than 1 billion people
...
-- The name and average life expectancy of all countries in southern regions for which an 
-- average life expectancy has been provided (i.e. not equal to null)
...
-- The name, continent, GNP, and average life expectancy of all countries in 
-- Africa or Asia that have an average life expectancy of at least 70 years 
-- and a GNP between $1 million and $100 million dollars
