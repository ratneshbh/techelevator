...
FROM country 
WHERE continent = 'North America' OR continent = 'South America' AND continent != 'Caribbean'; 
-- or WHERE continent IN ('North America', 'South America') AND region <> 'Caribbean';
...
FROM country 
WHERE GNP > 1000000 AND population < 1000000000; -- look at the data sometimes and document it 
...
FROM country 
WHERE (continent = 'Africa' OR continent = 'Asia') AND lifeexpectancy >= 70 AND GNP > 1000 AND GNP < 100000;