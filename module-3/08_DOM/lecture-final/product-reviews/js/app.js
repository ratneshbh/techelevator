const pageTitle = 'Cigar Parties for Dummies';//changed from
...
function setPageTitle() {
  ...
  const title = document.querySelector("#page-title .name");
  title.innerText = pageTitle;//changed from name
...
function setPageDescription() {
  ...
  //const descriptionright = document.querySelector(".description");
  //descriptionright.innerText = description;
...
function addTitle(parent, title) {
  ...
  const idk = document.createElement("h3");
  idk.innerText = title;
  parent.appendChild(idk);
